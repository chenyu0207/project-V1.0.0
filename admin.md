...
INSERT INTO `pro_auth_extend` (`group_id`, `extend_id`, `type`) VALUES
(1, 1, 1),
(1, 1, 2),
(1, 2, 1),
(1, 2, 2),
...
CREATE TABLE `pro_document_download` (
  `id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT '文档ID',
  `parse` tinyint(3) UNSIGNED NOT NULL DEFAULT '0' COMMENT '内容解析类型',
...
INSERT INTO `pro_model` (`id`, `name`, `title`, `extend`, `relation`, `need_pk`, `field_sort`, `field_group`, `attribute_list`, `template_list`, `template_add`, `template_edit`, `list_grid`, `list_row`, `search_key`, `search_list`, `create_time`, `update_time`, `status`) VALUES
...
--
-- Table structure for table `pro_picture`
--
...
--
-- Table structure for table `pro_ucenter_admin`
--

CREATE TABLE `pro_ucenter_admin` (
...
--
-- Dumping data for table `pro_ucenter_admin`
--

INSERT INTO `pro_ucenter_admin` (`id`, `member_id`, `status`) VALUES
(1, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `pro_ucenter_app`
--

CREATE TABLE `pro_ucenter_app` (
...
--
-- Table structure for table `pro_ucenter_member`
--

CREATE TABLE `pro_ucenter_member` (
...
--
-- Dumping data for table `pro_ucenter_member`
--

INSERT INTO `pro_ucenter_member` (`id`, `username`, `password`, `email`, `mobile`, `reg_time`, `reg_ip`, `last_login_time`, `last_login_ip`, `update_time`, `status`) VALUES
(1, 'root', '0e813f02f7154794913eb4886e7ded89', 'root@test.com', '', 1529393169, 0, 1529393265, 0, 1529393169, 1);

-- --------------------------------------------------------

--
-- Table structure for table `pro_ucenter_setting`
--

CREATE TABLE `pro_ucenter_setting` (
...
--
-- Table structure for table `pro_url`
--

CREATE TABLE `pro_url` (
...
--
-- Table structure for table `pro_userdata`
--

CREATE TABLE `pro_userdata` (
  `uid` int(10) UNSIGNED NOT NULL COMMENT '用户id',
...
--
-- Indexes for table `pro_action`
--
ALTER TABLE `pro_action`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pro_action_log`
--
ALTER TABLE `pro_action_log`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `pro_addons`
--
ALTER TABLE `pro_addons`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pro_attachment`
--
ALTER TABLE `pro_attachment`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_record_status` (`record_id`,`status`);

--
-- Indexes for table `pro_attribute`
--
ALTER TABLE `pro_attribute`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pro_auth_extend`
--
ALTER TABLE `pro_auth_extend`
  ADD UNIQUE KEY `group_extend_type` (`group_id`,`extend_id`,`type`),
  ADD KEY `uid` (`group_id`),
  ADD KEY `group_id` (`extend_id`);

--
-- Indexes for table `pro_auth_group`
--
ALTER TABLE `pro_auth_group`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pro_auth_group_access`
--
ALTER TABLE `pro_auth_group_access`
  ADD UNIQUE KEY `uid_group_id` (`uid`,`group_id`),
  ADD KEY `uid` (`uid`),
  ADD KEY `group_id` (`group_id`);

--
-- Indexes for table `pro_auth_rule`
--
ALTER TABLE `pro_auth_rule`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `name` (`module`,`name`,`type`);
...
--
-- Indexes for table `pro_channel`
--
ALTER TABLE `pro_channel`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pro_config`
--
ALTER TABLE `pro_config`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_name` (`name`);

--
-- Indexes for table `pro_document`
--
ALTER TABLE `pro_document`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_name` (`name`),
  ADD KEY `idx_category_status` (`category_id`,`status`),
  ADD KEY `idx_status_type_pid` (`status`,`type`,`pid`);

--
-- Indexes for table `pro_document_article`
--
ALTER TABLE `pro_document_article`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pro_document_download`
--
ALTER TABLE `pro_document_download`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `pro_hooks`
--
ALTER TABLE `pro_hooks`
  ADD PRIMARY KEY (`id`),
...
ALTER TABLE `pro_member`
  ADD PRIMARY KEY (`uid`),
  ADD UNIQUE KEY `ix_uid` (`uid`);

--
-- Indexes for table `pro_menu`
--
ALTER TABLE `pro_menu`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pro_model`
--
...
--
-- Indexes for table `pro_ucenter_admin`
--
ALTER TABLE `pro_ucenter_admin`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pro_ucenter_app`
--
ALTER TABLE `pro_ucenter_app`
  ADD PRIMARY KEY (`id`),
  ADD KEY `status` (`status`);

--
-- Indexes for table `pro_ucenter_member`
--
ALTER TABLE `pro_ucenter_member`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `pro_ucenter_setting`
--
ALTER TABLE `pro_ucenter_setting`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pro_url`
--
ALTER TABLE `pro_url`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `pro_userdata`
--
ALTER TABLE `pro_userdata`
...
--
-- AUTO_INCREMENT for table `pro_action`
--
ALTER TABLE `pro_action`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键', AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `pro_action_log`
--
ALTER TABLE `pro_action_log`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键', AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `pro_addons`
--
ALTER TABLE `pro_addons`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键', AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT for table `pro_attachment`
--
ALTER TABLE `pro_attachment`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pro_attribute`
--
ALTER TABLE `pro_attribute`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=187;

--
-- AUTO_INCREMENT for table `pro_auth_group`
--
ALTER TABLE `pro_auth_group`
  MODIFY `id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '用户组id,自增主键', AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `pro_auth_rule`
--
ALTER TABLE `pro_auth_rule`
  MODIFY `id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '规则id,自增主键', AUTO_INCREMENT=211;
...
--
-- AUTO_INCREMENT for table `pro_channel`
--
ALTER TABLE `pro_channel`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '频道ID', AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `pro_config`
--
ALTER TABLE `pro_config`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '配置ID', AUTO_INCREMENT=33;

--
-- AUTO_INCREMENT for table `pro_document`
--
ALTER TABLE `pro_document`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '文档ID', AUTO_INCREMENT=102;

--
-- AUTO_INCREMENT for table `pro_file`
--
ALTER TABLE `pro_file`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '文件ID', AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT for table `pro_hooks`
--
ALTER TABLE `pro_hooks`
...
--
ALTER TABLE `pro_member`
  MODIFY `uid` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '用户ID', AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT for table `pro_menu`
--
ALTER TABLE `pro_menu`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '文档ID', AUTO_INCREMENT=118;

--
-- AUTO_INCREMENT for table `pro_model`
--
ALTER TABLE `pro_model`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '模型ID', AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `pro_picture`
--
ALTER TABLE `pro_picture`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键id自增', AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT for table `pro_ucenter_admin`
--
ALTER TABLE `pro_ucenter_admin`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '管理员ID', AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `pro_ucenter_app`
--
ALTER TABLE `pro_ucenter_app`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '应用ID', AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `pro_ucenter_member`
--
ALTER TABLE `pro_ucenter_member`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '用户ID', AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT for table `pro_ucenter_setting`
--
ALTER TABLE `pro_ucenter_setting`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '设置ID';

--
-- AUTO_INCREMENT for table `pro_url`
--
ALTER TABLE `pro_url`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '链接唯一标识', AUTO_INCREMENT=4;
